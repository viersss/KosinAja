<footer class="site-footer">
        ...
        <div class="footer-bottom-bar">
            <div class="copyright-text">&copy; 2025 KosinAja. Proyek Akhir Individu - Pemrograman Berbasis Web.</div>
            <div class="legal-links"><a href="kebijakan_privasi.php">Kebijakan Privasi</a><a href="syarat_dan_ketentuan.php">Syarat & Ketentuan</a></div>
        </div>
    </footer>
